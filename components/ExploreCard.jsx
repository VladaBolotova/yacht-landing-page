...
const ExploreCard = ({id, imgUrl, title, index, active, handleClick}) => (
  ...
  className={`relative ${
    ...
    'lg:flex-[0.5] flex-[2]'} flex items-center justify-center mit-w-[170px]
...
{title}
      ...
      justifu-start w-full flex-col bg-[rgba(0,0,0,0.5)] rounded-b-[24px]">
        ...
        <p className="fonr-normal text-[16px] leading-[20px] text-white uppercase">
          Click to explore

        </p>
        <h2 className="mt-[24px] fonr-semibold
